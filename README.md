...
This plugin makes impactful and semantically useful in-article "cards" segments from plain article areas denoted by groups of `<h3>` crossheads and paragraphs or other elements beneath.
